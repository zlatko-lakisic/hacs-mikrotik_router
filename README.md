...
Maintained fork of [`tomaae/homeassistant-mikrotik_router`](https://github.com/tomaae/homeassistant-mikrotik_router) with RouterOS 7 / Home Assistant compatibility fixes.
![GitHub release (latest by date)](https://img.shields.io/github/v/release/zlatko-lakisic/hacs-mikrotik_router?style=plastic)
...
![GitHub all releases](https://img.shields.io/github/downloads/zlatko-lakisic/hacs-mikrotik_router/total?style=plastic)

![GitHub commits since latest release](https://img.shields.io/github/commits-since/zlatko-lakisic/hacs-mikrotik_router/latest?style=plastic)
![GitHub commit activity](https://img.shields.io/github/commit-activity/m/zlatko-lakisic/hacs-mikrotik_router?style=plastic)
![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/zlatko-lakisic/hacs-mikrotik_router/ci.yml?branch=master&style=plastic)
...
![English](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/flags/us.png)
![Arabic](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/flags/eg.png)
![Chinese](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/flags/cn.png)
![Czech](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/flags/cz.png)
![Dutch](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/flags/nl.png)
![French](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/flags/fr.png)
![German](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/flags/de.png)
![Greek](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/flags/gr.png)
![Hindi](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/flags/in.png)
![Hungarian](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/flags/hu.png)
![Icelandic](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/flags/is.png)
![Italian](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/flags/it.png)
![Japanese](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/flags/jp.png)
![Korean](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/flags/kr.png)
![Latvian](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/flags/lv.png)
![Polish](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/flags/pl.png)
![Portuguese](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/flags/pt.png)
![Russian](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/flags/ru.png)
![Slovak](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/flags/sk.png)
![Spanish](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/flags/es.png)
![Turkish](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/flags/tr.png)
![Vietnamese](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/flags/vn.png)

![Mikrotik Logo](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/ui/header.png)
...
![Interface Info](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/ui/interface.png)
![Interface Switch](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/ui/interface_switch.png)
![Interface Sensor](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/ui/interface_sensor.png)
...
![NAT switch](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/ui/nat.png)
...
![Mangle switch](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/ui/mangle_switch.png)
...
![Queue switch](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/ui/queue_switch.png)


## PPP
Control and monitor PPP users.

![PPP switch](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/ui/ppp_switch.png)
![PPP tracker](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/ui/ppp_tracker.png)
...
![Host tracker](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/ui/host_tracker.png)

## Netwatch Tracking
Track netwatch status.

![Netwatch](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/ui/netwatch_tracker.png)

## Scripts
Execute Mikrotik Router scripts.
You can execute scripts by automatically created switches or using services.

![Script Switch](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/ui/script_switch.png)

## Kid Control
Monitor and control Kid Control.

![Kid Control Enable](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/ui/kidcontrol_switch.png)
![Kid Control Pause](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/ui/kidcontrol_pause_switch.png)
...
![Accounting sensor](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/ui/accounting_sensor.png)

## UPS sensor
Monitor your UPS.

![UPS sensor](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/ui/ups.png)

## GPS sensors
Monitor your GPS coordinates.

![GPS sensor](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/ui/gps.png)

## Update sensor
Update Mikrotik OS and firmare directly from Home Assistant.

![RouterOS update](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/ui/routeros_update.png)
![Firmware update](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/ui/firmware_update.png)
...
![Add Integration](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/ui/setup_integration.png)
...
![Integration options](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/ui/integration_options.png)
...
![Integration sensors](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/ui/integration_options_sensors.png)
...
If you want to add translations for a language that is not listed please [open a Feature request](https://github.com/zlatko-lakisic/hacs-mikrotik_router/issues/new?labels=enhancement&title=%5BLokalise%5D%20Add%20new%20translations%20language).

## Diagnostics
Download diagnostics data for investigation:

![Diagnostics](https://raw.githubusercontent.com/zlatko-lakisic/hacs-mikrotik_router/master/docs/assets/images/ui/diagnostics.png)
